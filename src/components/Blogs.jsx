        ...
        <section className="centered-section">
            ...
            <div className="blogs-wrapper">
                ...
                <div className="card-footer">
                    <small className="text-muted blogs-footer"><a href="https://mindstory.in/how-much-should-a-small-business-actually-spend-on-digital-marketinghow-much-should-a-small-business-actually-spend-on-digital-marketing/">continue reading</a></small>
                </div>
            </div>
            <div className="card blog-card" style={{width: '18rem'}}>
                ...
                <div className="card-footer">
                    <small className="text-muted blogs-footer"><a href="https://mindstory.in/https-mindstory-in/">continue reading</a></small>
                </div>
            </div>
            ...
            <div className="card blog-card" style={{width: '18rem'}}>
                ...
                <div className="card-footer">
                    <small className="text-muted blogs-footer"><a href="https://mindstory.in/why-reels-are-your-fastest-business-growth-tool-right-now/">continue reading</a></small>
                </div>
            </div>
            <div className="card blog-card" style={{width: '18rem'}}>
                ...
                <div className="card-footer">
                    <small className="text-muted blogs-footer"><a href="https://mindstory.in/top-5-seo-agencies-in-thrissur-that-businesses-trust-in-2026/">continue reading</a></small>
                </div>
            </div>
            </div>
        </section>
