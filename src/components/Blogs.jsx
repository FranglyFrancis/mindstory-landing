        ...
        <section className="centered-section">
            ...
            <div className="blogs-wrapper">
                ...
                <div className="card blog-card" style={{width: '18rem'}}>
                    <img src={digital} className="card-img-top w-80 mx-auto" alt="small business and digital marketing" />
                ...
                <div className="card blog-card" style={{width: '18rem'}}>
                    <img src={google} className="card-img-top w-80 mx-auto" alt="google rating" />
                    <div className="card-body">
                ...
                <div className="card blog-card" style={{width: '18rem'}}>
                    <img src={reels} className="card-img-top w-80 mx-auto" alt="reels importance in business" />
                    <div className="card-body">
                ...
                <div className="card blog-card" style={{width: '18rem'}}>
                    <img src={top5} className="card-img-top w-80 mx-auto" alt="top 5 seo agencies in thrissur" />
                    <div className="card-body">
